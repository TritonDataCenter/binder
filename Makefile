...
SMF_MANIFESTS_IN = smf/manifests/binder.xml.in deps/zookeeper-base/smf/manifests/zookeeper.xml.in
...
release: all docs $(SMF_MANIFESTS)
	...
	cp -R $(ROOT)/deps/zookeeper-base/boot/* $(RELSTAGEDIR)/root/opt/smartdc/boot/
